...
export function Header() {
    return (
        <header className="fixed z-50 w-screen px-4 md:px-16 lg:px-28 h-32 md:h-20 justify-between items-center flex flex-col md:flex-row py-4 bg-white">
            <div className="flex container mx-auto py-3 justify-between">
                ...
                <div className="flex items-center gap-2 md:gap-4 relative">
                    ...
                    <a href="/cart" className="static px-1">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                        ...
                        {/* <div className="absolute bg-(--green-medium) right-0 text-xs px-1 rounded-full top-0 md:top-0.5 text-white">
                            5
                        </div> */}
                    </a>
                </div>
